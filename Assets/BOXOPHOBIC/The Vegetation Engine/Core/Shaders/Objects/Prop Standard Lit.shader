		...
		Pass
		{
           ...
           #pragma multi_compile GPU_FRUSTUM_ON __
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float2 lerpResult1545_g53628 = lerp( v.texcoord.xy , v.texcoord1.xyzw.xy , _DetailCoordMode);
				float3 ase_worldPos = mul(GetObjectToWorldMatrix(), v.vertex).xyz;
				#if defined(TVE_DETAIL_TYPE_VERTEX_BLUE)
				float2 staticSwitch3466_g53628 = lerpResult1545_g53628;
				#elif defined(TVE_DETAIL_TYPE_PROJECTION)
				float2 staticSwitch3466_g53628 = (ase_worldPos).xz;
				#else
				float2 staticSwitch3466_g53628 = lerpResult1545_g53628;
				#endif
				float2 vertexToFrag11_g53652 = ( ( staticSwitch3466_g53628 * (_SecondUVs).xy ) + (_SecondUVs).zw );
				o.ase_texcoord7.zw = vertexToFrag11_g53652;
				half Mesh_DetailMask90_g53628 = v.ase_color.b;
				float vertexToFrag11_g53685 = ( ( Mesh_DetailMask90_g53628 - 0.5 ) + _DetailMeshValue );
				o.ase_texcoord8.x = vertexToFrag11_g53685;
				float3 vertexToFrag3890_g53628 = ase_worldPos;
				o.ase_texcoord8.yzw = vertexToFrag3890_g53628;
						...
						, FRONT_FACE_TYPE ase_vface : FRONT_FACE_SEMANTIC ) : SV_Target
			{
				...
				half2 Main_UVs15_g53628 = vertexToFrag11_g53657;
				float4 tex2DNode29_g53628 = SAMPLE_TEXTURE2D( _MainAlbedoTex, sampler_MainAlbedoTex, Main_UVs15_g53628 );
				float3 temp_output_51_0_g53628 = ( (_MainColor).rgb * (tex2DNode29_g53628).rgb );
				half3 Main_Albedo99_g53628 = temp_output_51_0_g53628;
				float2 vertexToFrag11_g53652 = IN.ase_texcoord7.zw;
				half2 Second_UVs17_g53628 = vertexToFrag11_g53652;
				half3 Second_Albedo153_g53628 = (( _SecondColor * SAMPLE_TEXTURE2D( _SecondAlbedoTex, sampler_SecondMaskTex, Second_UVs17_g53628 ) )).rgb;
				...
				float temp_output_3919_0_g53628 = vertexToFrag11_g53685;
				float3 unpack4112_g53628 = UnpackNormalScale( SAMPLE_TEXTURE2D( _MainNormalTex, sampler_MainAlbedoTex, Main_UVs15_g53628 ), _MainNormalValue );
				unpack4112_g53628.z = lerp( 1, unpack4112_g53628.z, saturate(_MainNormalValue) );
				half3 Main_Normal137_g53628 = unpack4112_g53628;
				float3 tanToWorld0 = float3( WorldTangent.x, WorldBiTangent.x, WorldNormal.x );
				float3 tanToWorld1 = float3( WorldTangent.y, WorldBiTangent.y, WorldNormal.y );
				float3 tanToWorld2 = float3( WorldTangent.z, WorldBiTangent.z, WorldNormal.z );
				float3 tanNormal4099_g53628 = Main_Normal137_g53628;
				float3 worldNormal4099_g53628 = float3(dot(tanToWorld0,tanNormal4099_g53628), dot(tanToWorld1,tanNormal4099_g53628), dot(tanToWorld2,tanNormal4099_g53628));
				float3 Main_Normal_WS4101_g53628 = worldNormal4099_g53628;
				float lerpResult1537_g53628 = lerp( Main_Normal_WS4101_g53628.y , -Main_Normal_WS4101_g53628.y , _DetailProjectionMode);
				#if defined(TVE_DETAIL_TYPE_VERTEX_BLUE)
				float staticSwitch3467_g53628 = temp_output_3919_0_g53628;
				#elif defined(TVE_DETAIL_TYPE_PROJECTION)
				float staticSwitch3467_g53628 = ( ( lerpResult1537_g53628 * 0.5 ) + _DetailMeshValue );
				#else
				float staticSwitch3467_g53628 = temp_output_3919_0_g53628;
				#endif
				half Blend_Source1540_g53628 = staticSwitch3467_g53628;
				float4 tex2DNode35_g53628 = SAMPLE_TEXTURE2D( _MainMaskTex, sampler_MainAlbedoTex, Main_UVs15_g53628 );
				half Main_Mask57_g53628 = tex2DNode35_g53628.b;
				float4 tex2DNode33_g53628 = SAMPLE_TEXTURE2D( _SecondMaskTex, sampler_SecondMaskTex, Second_UVs17_g53628 );
				half Second_Mask81_g53628 = tex2DNode33_g53628.b;
				float lerpResult1327_g53628 = lerp( Main_Mask57_g53628 , Second_Mask81_g53628 , _DetailMaskMode);
				float lerpResult4058_g53628 = lerp( lerpResult1327_g53628 , ( 1.0 - lerpResult1327_g53628 ) , _DetailMaskInvertMode);
				float temp_output_7_0_g53694 = _DetailBlendMinValue;
				half Mask_Detail147_g53628 = saturate( ( ( saturate( ( Blend_Source1540_g53628 + ( Blend_Source1540_g53628 * lerpResult4058_g53628 ) ) ) - temp_output_7_0_g53694 ) / ( _DetailBlendMaxValue - temp_output_7_0_g53694 ) ) );
				float3 lerpResult235_g53628 = lerp( Main_Albedo99_g53628 , ( Main_Albedo99_g53628 * Second_Albedo153_g53628 * staticSwitch1_g53688 ) , Mask_Detail147_g53628);
				float3 lerpResult208_g53628 = lerp( Main_Albedo99_g53628 , Second_Albedo153_g53628 , Mask_Detail147_g53628);
				#if defined(TVE_DETAIL_BLEND_OVERLAY)
				float3 staticSwitch4062_g53628 = lerpResult235_g53628;
				#elif defined(TVE_DETAIL_BLEND_REPLACE)
				float3 staticSwitch4062_g53628 = lerpResult208_g53628;
				#else
				float3 staticSwitch4062_g53628 = lerpResult235_g53628;
				#endif
				#if defined(TVE_DETAIL_MODE_OFF)
				float3 staticSwitch255_g53628 = Main_Albedo99_g53628;
				#elif defined(TVE_DETAIL_MODE_ON)
				float3 staticSwitch255_g53628 = staticSwitch4062_g53628;
				#else
				float3 staticSwitch255_g53628 = Main_Albedo99_g53628;
				#endif
				half3 Blend_Albedo265_g53628 = staticSwitch255_g53628;
				half3 Blend_AlbedoTinted2808_g53628 = ( float3(1,1,1) * float3(1,1,1) * float3(1,1,1) * Blend_Albedo265_g53628 );
				half3 Blend_AlbedoColored863_g53628 = Blend_AlbedoTinted2808_g53628;
				half3 Blend_AlbedoAndSubsurface149_g53628 = Blend_AlbedoColored863_g53628;
				half3 Global_OverlayColor1758_g53628 = (TVE_OverlayColor).rgb;
				float lerpResult3567_g53628 = lerp( _OverlayBottomValue , 1.0 , Main_Normal_WS4101_g53628.y);
				half Main_AlbedoTex_G3526_g53628 = tex2DNode29_g53628.g;
				half Second_AlbedoTex_G3581_g53628 = (SAMPLE_TEXTURE2D( _SecondAlbedoTex, sampler_SecondMaskTex, Second_UVs17_g53628 )).g;
				float lerpResult3579_g53628 = lerp( Main_AlbedoTex_G3526_g53628 , Second_AlbedoTex_G3581_g53628 , Mask_Detail147_g53628);
				#if defined(TVE_DETAIL_MODE_OFF)
				float staticSwitch3574_g53628 = Main_AlbedoTex_G3526_g53628;
				#elif defined(TVE_DETAIL_MODE_ON)
				float staticSwitch3574_g53628 = lerpResult3579_g53628;
				#else
				float staticSwitch3574_g53628 = Main_AlbedoTex_G3526_g53628;
				#endif
				float3 vertexToFrag3890_g53628 = IN.ase_texcoord8.yzw;
				float3 WorldPosition3905_g53628 = vertexToFrag3890_g53628;
				float3 Position82_g53655 = WorldPosition3905_g53628;
				...
				half Global_Extras_Overlay156_g53628 = break89_g53655.b;
				float temp_output_1025_0_g53628 = ( _GlobalOverlay * Global_Extras_Overlay156_g53628 );
				half Overlay_Commons1365_g53628 = temp_output_1025_0_g53628;
				float temp_output_7_0_g53684 = _OverlayMaskMinValue;
				half Overlay_Mask269_g53628 = saturate( ( ( ( ( ( lerpResult3567_g53628 * 0.5 ) + staticSwitch3574_g53628 ) * Overlay_Commons1365_g53628 ) - temp_output_7_0_g53684 ) / ( _OverlayMaskMaxValue - temp_output_7_0_g53684 ) ) );
				float3 lerpResult336_g53628 = lerp( Blend_AlbedoAndSubsurface149_g53628 , Global_OverlayColor1758_g53628 , Overlay_Mask269_g53628);
				half3 Final_Albedo359_g53628 = lerpResult336_g53628;
				
				float3 unpack4114_g53628 = UnpackNormalScale( SAMPLE_TEXTURE2D( _SecondNormalTex, sampler_SecondMaskTex, Second_UVs17_g53628 ), _SecondNormalValue );
				unpack4114_g53628.z = lerp( 1, unpack4114_g53628.z, saturate(_SecondNormalValue) );
				half3 Second_Normal179_g53628 = unpack4114_g53628;
				float3 lerpResult230_g53628 = lerp( float3( 0,0,1 ) , Second_Normal179_g53628 , Mask_Detail147_g53628);
				float3 lerpResult3372_g53628 = lerp( float3( 0,0,1 ) , Main_Normal137_g53628 , _DetailNormalValue);
				float3 lerpResult3376_g53628 = lerp( Main_Normal137_g53628 , BlendNormal( lerpResult3372_g53628 , Second_Normal179_g53628 ) , Mask_Detail147_g53628);
				#if defined(TVE_DETAIL_BLEND_OVERLAY)
				float3 staticSwitch4063_g53628 = BlendNormal( Main_Normal137_g53628 , lerpResult230_g53628 );
				#elif defined(TVE_DETAIL_BLEND_REPLACE)
				float3 staticSwitch4063_g53628 = lerpResult3376_g53628;
				#else
				float3 staticSwitch4063_g53628 = BlendNormal( Main_Normal137_g53628 , lerpResult230_g53628 );
				#endif
				#if defined(TVE_DETAIL_MODE_OFF)
				float3 staticSwitch267_g53628 = Main_Normal137_g53628;
				#elif defined(TVE_DETAIL_MODE_ON)
				float3 staticSwitch267_g53628 = staticSwitch4063_g53628;
				#else
				float3 staticSwitch267_g53628 = Main_Normal137_g53628;
				#endif
				float3 temp_output_13_0_g53686 = staticSwitch267_g53628;
				float3 switchResult12_g53686 = (((ase_vface>0)?(temp_output_13_0_g53686):(( temp_output_13_0_g53686 * _render_normals_options ))));
				half3 Blend_Normal312_g53628 = switchResult12_g53686;
				half3 Final_Normal366_g53628 = Blend_Normal312_g53628;
				
				float4 temp_output_4214_0_g53628 = ( _EmissiveColor * _EmissiveIntensityParams.x );
				float2 vertexToFrag11_g53638 = IN.ase_texcoord9.xy;
				half2 Emissive_UVs2468_g53628 = vertexToFrag11_g53638;
				half Global_Extras_Emissive4203_g53628 = break89_g53655.r;
				float lerpResult4206_g53628 = lerp( 1.0 , Global_Extras_Emissive4203_g53628 , _GlobalEmissive);
				half3 Final_Emissive2476_g53628 = ( (( temp_output_4214_0_g53628 * SAMPLE_TEXTURE2D( _EmissiveTex, sampler_EmissiveTex, Emissive_UVs2468_g53628 ) )).rgb * lerpResult4206_g53628 );
				
				half Main_Metallic237_g53628 = ( tex2DNode35_g53628.r * _MainMetallicValue );
				half Second_Metallic226_g53628 = ( tex2DNode33_g53628.r * _SecondMetallicValue );
				float lerpResult278_g53628 = lerp( Main_Metallic237_g53628 , Second_Metallic226_g53628 , Mask_Detail147_g53628);
				#if defined(TVE_DETAIL_BLEND_OVERLAY)
				float staticSwitch4064_g53628 = Main_Metallic237_g53628;
				#elif defined(TVE_DETAIL_BLEND_REPLACE)
				float staticSwitch4064_g53628 = lerpResult278_g53628;
				#else
				float staticSwitch4064_g53628 = Main_Metallic237_g53628;
				#endif
				#if defined(TVE_DETAIL_MODE_OFF)
				float staticSwitch299_g53628 = Main_Metallic237_g53628;
				#elif defined(TVE_DETAIL_MODE_ON)
				float staticSwitch299_g53628 = staticSwitch4064_g53628;
				#else
				float staticSwitch299_g53628 = Main_Metallic237_g53628;
				#endif
				half Blend_Metallic306_g53628 = staticSwitch299_g53628;
				float lerpResult342_g53628 = lerp( Blend_Metallic306_g53628 , 0.0 , Overlay_Mask269_g53628);
				half Final_Metallic367_g53628 = lerpResult342_g53628;
				
				half Main_Smoothness227_g53628 = ( tex2DNode35_g53628.a * _MainSmoothnessValue );
				half Second_Smoothness236_g53628 = ( tex2DNode33_g53628.a * _SecondSmoothnessValue );
				float lerpResult266_g53628 = lerp( Main_Smoothness227_g53628 , Second_Smoothness236_g53628 , Mask_Detail147_g53628);
				#if defined(TVE_DETAIL_BLEND_OVERLAY)
				float staticSwitch4065_g53628 = Main_Smoothness227_g53628;
				#elif defined(TVE_DETAIL_BLEND_REPLACE)
				float staticSwitch4065_g53628 = lerpResult266_g53628;
				#else
				float staticSwitch4065_g53628 = Main_Smoothness227_g53628;
				#endif
				#if defined(TVE_DETAIL_MODE_OFF)
				float staticSwitch297_g53628 = Main_Smoothness227_g53628;
				#elif defined(TVE_DETAIL_MODE_ON)
				float staticSwitch297_g53628 = staticSwitch4065_g53628;
				#else
				float staticSwitch297_g53628 = Main_Smoothness227_g53628;
				#endif
				half Blend_Smoothness314_g53628 = staticSwitch297_g53628;
				half Global_OverlaySmoothness311_g53628 = TVE_OverlaySmoothness;
				float lerpResult343_g53628 = lerp( Blend_Smoothness314_g53628 , Global_OverlaySmoothness311_g53628 , Overlay_Mask269_g53628);
				half Final_Smoothness371_g53628 = lerpResult343_g53628;
				half Global_Extras_Wetness305_g53628 = break89_g53655.g;
				float lerpResult3673_g53628 = lerp( 0.0 , Global_Extras_Wetness305_g53628 , _GlobalWetness);
				half Final_SmoothnessAndWetness4130_g53628 = saturate( ( Final_Smoothness371_g53628 + lerpResult3673_g53628 ) );
				
				float lerpResult240_g53628 = lerp( 1.0 , tex2DNode35_g53628.g , _MainOcclusionValue);
				half Main_Occlusion247_g53628 = lerpResult240_g53628;
				float lerpResult239_g53628 = lerp( 1.0 , tex2DNode33_g53628.g , _SecondOcclusionValue);
				half Second_Occlusion251_g53628 = lerpResult239_g53628;
				float lerpResult294_g53628 = lerp( Main_Occlusion247_g53628 , Second_Occlusion251_g53628 , Mask_Detail147_g53628);
				#if defined(TVE_DETAIL_BLEND_OVERLAY)
				float staticSwitch4066_g53628 = Main_Occlusion247_g53628;
				#elif defined(TVE_DETAIL_BLEND_REPLACE)
				float staticSwitch4066_g53628 = lerpResult294_g53628;
				#else
				float staticSwitch4066_g53628 = Main_Occlusion247_g53628;
				#endif
				#if defined(TVE_DETAIL_MODE_OFF)
				float staticSwitch310_g53628 = Main_Occlusion247_g53628;
				#elif defined(TVE_DETAIL_MODE_ON)
				float staticSwitch310_g53628 = staticSwitch4066_g53628;
				#else
				float staticSwitch310_g53628 = Main_Occlusion247_g53628;
				#endif
				half Blend_Occlusion323_g53628 = staticSwitch310_g53628;
				
				float localCustomAlphaClip3735_g53628 = ( 0.0 );
				half Final_AlphaFade3727_g53628 = 1.0;
				float Main_Alpha316_g53628 = ( _MainColor.a * tex2DNode29_g53628.a );
				half AlphaTreshold2132_g53628 = _Cutoff;
				#ifdef TVE_ALPHA_CLIP
				float staticSwitch3792_g53628 = ( Main_Alpha316_g53628 - ( AlphaTreshold2132_g53628 - 0.5 ) );
				#else
				float staticSwitch3792_g53628 = Main_Alpha316_g53628;
				#endif
				half Final_Alpha3754_g53628 = staticSwitch3792_g53628;
				float temp_output_661_0_g53628 = ( Final_AlphaFade3727_g53628 * Final_Alpha3754_g53628 );
				float Alpha3735_g53628 = temp_output_661_0_g53628;
				float Treshold3735_g53628 = 0.5;
				{
				#if TVE_ALPHA_CLIP
				clip(Alpha3735_g53628 - Treshold3735_g53628);
				#endif
				}
				half Final_Clip914_g53628 = saturate( Alpha3735_g53628 );
				
				float3 Albedo = Final_Albedo359_g53628;
				float3 Normal = Final_Normal366_g53628;
				float3 Emission = Final_Emissive2476_g53628;
				float3 Specular = 0.5;
				float Metallic = Final_Metallic367_g53628;
				float Smoothness = Final_SmoothnessAndWetness4130_g53628;
				float Occlusion = Blend_Occlusion323_g53628;
				float Alpha = Final_Clip914_g53628;
		...
		Pass
		{
           ...
           #pragma multi_compile GPU_FRUSTUM_ON __
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float2 vertexToFrag11_g53657 = ( ( v.ase_texcoord.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				o.ase_texcoord2.xy = vertexToFrag11_g53657;
				float2 lerpResult1545_g53628 = lerp( v.ase_texcoord.xy , v.texcoord1.xy , _DetailCoordMode);
				float3 ase_worldPos = mul(GetObjectToWorldMatrix(), v.vertex).xyz;
				#if defined(TVE_DETAIL_TYPE_VERTEX_BLUE)
				float2 staticSwitch3466_g53628 = lerpResult1545_g53628;
				#elif defined(TVE_DETAIL_TYPE_PROJECTION)
				...
				float3 vertexToFrag3890_g53628 = ase_worldPos;
				o.ase_texcoord6.xyz = vertexToFrag3890_g53628;
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float staticSwitch3574_g53628 = Main_AlbedoTex_G3526_g53628;
				#endif
				float3 vertexToFrag3890_g53628 = IN.ase_texcoord6.xyz;
				float3 WorldPosition3905_g53628 = vertexToFrag3890_g53628;
				float3 Position82_g53655 = WorldPosition3905_g53628;
				float temp_output_84_0_g53655 = _LayerExtrasValue;
				float4 lerpResult88_g53655 = lerp( TVE_ExtrasParams , SAMPLE_TEXTURE2D_ARRAY( TVE_ExtrasTex, samplerTVE_ExtrasTex, ( (TVE_ExtrasCoord).zw + ( (TVE_ExtrasCoord).xy * (Position82_g53655).xz ) ),temp_output_84_0_g53655 ) , TVE_ExtrasUsage[(int)temp_output_84_0_g53655]);
		...
		Pass
		{
           ...
           #pragma multi_compile GPU_FRUSTUM_ON __
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float2 vertexToFrag11_g53657 = ( ( v.ase_texcoord.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				o.ase_texcoord2.xy = vertexToFrag11_g53657;
				float2 lerpResult1545_g53628 = lerp( v.ase_texcoord.xy , v.ase_texcoord1.xy , _DetailCoordMode);
				float3 ase_worldPos = mul(GetObjectToWorldMatrix(), v.vertex).xyz;
				#if defined(TVE_DETAIL_TYPE_VERTEX_BLUE)
				float2 staticSwitch3466_g53628 = lerpResult1545_g53628;
				#elif defined(TVE_DETAIL_TYPE_PROJECTION)
...
/*ASEBEGIN
Version=18910
1920;6;1920;1023;2914.487;767.213;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;398;-1344,-896;Inherit;False;Compile All Shaders;-1;;53702;e67c8238031dbf04ab79a5d4d63d1b4f;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;134;-1984,-896;Half;False;Property;_IsStandardShader;_IsStandardShader;195;1;[HideInInspector];Create;True;0;0;0;True;0;False;1;0;1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;127;-2176,-896;Half;False;Property;_IsPropShader;_IsPropShader;194;1;[HideInInspector];Create;True;0;0;0;True;0;False;1;0;1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;399;-1536,-896;Inherit;False;Compile Core;-1;;53627;634b02fd1f32e6a4c875d8fc2c450956;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;397;-1920,384;Inherit;False;Define FEATURES UNIVERSAL;-1;;53626;71dc7add32e5f6247b1fb74ecceddd3e;0;0;1;FLOAT;529
Node;AmplifyShaderEditor.FunctionNode;343;-2176,384;Inherit;False;Define SHADER OBJECT;-1;;53625;1237b3cc9fbfe714d8343c91216dc9b4;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;382;-2176,-384;Inherit;False;Base Shader;0;;53628;856f7164d1c579d43a5cf4968a75ca43;80,3882,1,3880,1,3957,0,4028,1,4029,1,3903,1,3900,1,4204,1,3904,1,3908,1,4172,1,1300,1,1298,1,4179,1,3586,0,1708,0,3658,0,3509,1,1712,0,3873,1,1717,1,1718,1,1714,1,1715,1,916,1,1762,0,1763,0,3568,1,1949,1,1776,0,3475,1,4210,1,893,0,1745,0,3479,0,3501,0,3221,2,1646,0,1757,0,1271,0,3889,1,2807,0,3886,0,2953,0,3887,0,3243,0,3888,0,3728,0,3949,0,2172,0,3883,0,2658,0,1742,0,3484,0,1736,1,1734,1,3575,1,1737,1,1735,1,1733,1,878,1,1550,1,4072,0,4070,0,4067,0,4068,0,4069,0,860,0,3544,1,2260,1,2261,1,2032,1,2054,1,4177,1,2062,1,2039,1,4217,1,3592,1,2750,0,4242,0;0;19;FLOAT3;0;FLOAT3;528;FLOAT3;2489;FLOAT;531;FLOAT;4135;FLOAT;529;FLOAT;3678;FLOAT;530;FLOAT;4127;FLOAT;4122;FLOAT;4134;FLOAT;1235;FLOAT3;1230;FLOAT;1461;FLOAT;1290;FLOAT;721;FLOAT;532;FLOAT;629;FLOAT3;534
...
ASEEND*/
//CHKSM=FB20544538B6D25DD8BB1D1A29685F2146F876B9
