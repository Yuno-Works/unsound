...
namespace TheVegetationEngine
{
    ...
    public class TVEGlobalMotion : StyledMonoBehaviour
    {
        ...
        void SetGlobalShaderProperties()
        {
            ...
            // Legacy
            Shader.SetGlobalVector("TVE_NoiseSpeed_Vegetation", speed);
            Shader.SetGlobalVector("TVE_NoiseSpeed_Grass", speed);
            Shader.SetGlobalFloat("TVE_NoiseSize_Vegetation", size);
            Shader.SetGlobalFloat("TVE_NoiseSize_Grass", size);
        }
    }
}
